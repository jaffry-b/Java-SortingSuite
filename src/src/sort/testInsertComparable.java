...
/**
 * @author Bilal Jaffry. 
 * @version testInsertComparable version 1.0, 02/22/18
 */
public class testInsertComparable {
	...
	/**
	 * Test method for {@link sort.Insertion#sortComparable(java.lang.Comparable<sort.Job>[], int)}.
	 * 
	 */
	...
	int count = 2;
		...
		System.out.printf("%.5f seconds. 2^%d for sortComparable\n",timer2.elapsedTime() ,count);
