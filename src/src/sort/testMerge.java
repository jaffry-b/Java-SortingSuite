...
/**
 * @author Bilal Jaffry. 
 * @version testMerge version 1.0, 02/22/18
 */
public class testMerge {
	...
	/**
	 * Test method for {@link sort.Merge#sortMerge(java.lang.Comparable<sort.Job>[], int)}.
	 */
	@Test
	public void testSortMerge() {
		...
		System.out.printf("%.5f seconds. 2^%d for sortMerge\n",timer2.elapsedTime() ,count);
